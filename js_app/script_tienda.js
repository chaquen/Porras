...
function iniciar_tienda(){
	consultarDatos("producto",{},function(rs){
		console.log(rs);
		dibujar_productos(rs.datos);
	});
}

function dibujar_productos(datos){
	...
	for(var c in datos){
		...
		h3.innerHTML=datos[c].nombre_producto;
		...
		var span=document.createElement("span");
		span.innerHTML="Talla:";
		div5.appendChild(span);
		var txt=document.createTextNode(datos[c].talla);
		...
		var txt=document.createTextNode(datos[c].color);
		...
		var txt=document.createTextNode(datos[c].material);
		...
		p.innerHTML=datos[c].descripcion_producto;
		div2.appendChild(p);
	...
	for(var c in datos){
		...
		li.className="span4 "+datos[c].tipo_producto;
		li.setAttribute("data-cat",datos[c].tipo_producto);
		var div=document.createElement("div");
